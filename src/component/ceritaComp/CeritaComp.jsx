        ...
        <div className='flex bg-color7'> 
             <div className='mx-auto mt-10 px-10 md:px-15 lg:px-32'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-auto
                     ...
                     {posts.map((item)=>(
                  <div key={item.id} className='m-4 cursor-pointer bg-white border border-gray-300 rounded-lg overflow-hidden' >
               ...
               <a href="/halaman-baru" className='font-jakarta block text-center text-blue-500 hover:underline mt-10 mb-6' >Lihat Lainnya ...</a>
              </div>
        </div>
