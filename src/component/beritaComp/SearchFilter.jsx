...
function SearchFilter({ selectedTag }) {
  const tags = [
    {
      id: 1,
      name: "Semua",
  ...
  return (
    <div className='flex bg-color8'>
      ...
      <div className='flex gap-3 mt-10 mb-10 mx-20'>
        {tags.map((item, index) => (
          <ul
            key={item.id}
            onClick={() => {
      ...
      {/* SearchFilterFilter bar di sebelah kanan */}
      <div className='ml-auto flex gap-3 mt-10 mb-10 mx-20'>
